...
class BusinessViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UIGestureRecognizerDelegate {
    ...
    func setNavBar() {
        ...
        let searchBtnItem = UIBarButtonItem(image: UIImage(named: "business_navBar_search"), style: .Plain, target: self, action: "onSearchBtn:")
        navigationItem.rightBarButtonItem = searchBtnItem
        
        let mapBtnItem = UIBarButtonItem(image: UIImage(named: "business_navBar_map"), style: .Plain, target: self, action: "onMapBtn:")
    ...
    func initView() {
        ...
        for var i = 0; i < 3; i++ {
            ...
            filterBtn.addTarget(self, action: "OnFilterBtn:", forControlEvents: .TouchUpInside)
        ...
        let tap = UITapGestureRecognizer(target: self, action: "onTapMaskView:")
        tap.delegate = self
        ...
        func tableView(tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
            ...
            refreshBtn.addTarget(self, action: "onRefrshBtn:", forControlEvents: .TouchUpInside)
